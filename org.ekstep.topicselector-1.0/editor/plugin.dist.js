...
org.ekstep.pluginframework.pluginManager.registerPlugin({"id":"org.ekstep.topicselector","ver":"1.0","author":"Gourav More","title":"Topic Selector Plugin","description":"Topic and subtopic selector plugin","publishedDate":"","editor":{"main":"editor/plugin.js","dependencies":[{"type":"js","src":"editor/topic-semantic-ui-tree-picker.js"},{"type":"css","src":"editor/topic-semantic-ui-tree-picker.css"}]}},org.ekstep.contenteditor.basePlugin.extend({topicData:[],response:[],terms:[],selectedFilters:[],topics:[],categories:[],data:[],isPopupInitialized:!1,template:void 0,initialize:function(){ecEditor.addEventListener(this.manifest.id+":init",this.initTopicBrowser,this),ecEditor.addEventListener("editor:field:association",this.applyFilters,this)},initTopicBrowser:function(e,t){var i=this;i.data=t,i.terms=[],i.getCategory(function(){0<i.categories.length?i.getTopics(i.categories,function(t){i.topicData=ecEditor._.uniqBy(t,"id"),i.topics=i.topicData,i.isPopupInitialized=!0,i.selectedFilters=[],i.data.isCategoryDependant?i.getFormData(function(t){i.setAssociations(t,function(){i.setFiltersData(function(){i.showTopicBrowser(e,i.data)})})}):i.showTopicBrowser(e,i.data)}):(i.isPopupInitialized=!0,i.showTopicBrowser(e,i.data))})},getFormConfig:function(e){var i=this;ecEditor.dispatchEvent("editor:form:getconfig",function(t){i.template=t.template;t=_.map(_.filter(t.fields,_.matches({depends:["topic"]})),"code");i.terms=t,e(t)})},getFormData:function(i){var t=this;t.getFormConfig(function(e){ecEditor.dispatchEvent("metadata:form:getdata",{target:"#"+t.template,callback:function(t){t=_.pick(t,e);i(t)}})})},getTopics:function(o,a){var n=this,s=[];o&&o.length?ecEditor._.forEach(o,function(t,e){var i={};i.id=t.identifier,i.name=t.name,i.selectable="selectable",i.nodes=n.getSubtopics(t.children),s.push(i),e===o.length-1&&a(s)}):a(s)},getSubtopics:function(t){var i=this,o=[];return ecEditor._.forEach(t,function(t){var e={};e.id=t.identifier,e.name=t.name,e.selectable="selectable",e.nodes=i.getSubtopics(t.children),o.push(e)}),ecEditor._.uniqBy(o,"id")},getCategory:function(i){var o=this,t=org.ekstep.contenteditor.api.getContext("framework")||ecEditor.getService("content").getContentMeta(org.ekstep.contenteditor.api.getContext("contentId")).framework;t?ecEditor.getService(ServiceConstants.META_SERVICE).getCategorys(t,function(t,e){t||(o.response=e.data.result.framework.categories,ecEditor._.forEach(o.response,function(t,e){"topic"==t.code&&(o.categories=t.terms)})),i()}):i()},applyFilters:function(i,o){var a=this;a.selectedFilters=[],a.isPopupInitialized&&o.field.depends&&o.field.depends.length&&_.forEach(o.field.depends,function(t){var e;"topic"==t&&o.resetSelected&&(a.data.selectedTopics=[],ecEditor.dispatchEvent("editor.topic.change",{key:"topic",value:[]}),o.target&&(e=o.target.replace("#","")),ecEditor.dispatchEvent("metadata:form:getdata",{target:o.target,callback:function(t){a.setAssociations(t,function(){a.setFiltersData(function(){e&&(a.data.element=e+"-topic"),a.showTopicBrowser(i,a.data)})})}}))})},setFiltersData:function(n){var s=this,c=[];0<s.selectedFilters.length?ecEditor._.forEach(s.selectedFilters,function(t,e){var i,o,a;0<t.association.length&&(i=[],ecEditor._.forEach(t.association[0],function(t,e){"topic"==t.category&&i.push(t.identifier)}),0<i.length)&&c.push(i),e===s.selectedFilters.length-1&&(o=_.intersection.apply(_,c),a=[],ecEditor._.forEach(s.topics,function(e,t){ecEditor._.forEach(o,function(t){e.id==t&&a.push(e)})}),s.topicData=a,n())}):n()},setAssociations:function(a,t){var n=this;n.terms=ecEditor._.uniq(n.terms),ecEditor._.forEach(n.terms,function(e,t){var o,i;a[e]&&((o={}).name=e,o.value=a[e],o.association=[],i=_.find(n.response,function(t){return t.code===e}).terms,ecEditor._.forEach(i,function(i,t){ecEditor._.isUndefined(i.associations)||(_.isArray(a[e])&&0<i.associations.length?ecEditor._.forEach(a[e],function(t,e){i.name==t&&0<o.association.length?(i.associations=_.union(o.association[0],i.associations),o.association=i.associations):i.name==t&&o.association.push(i.associations)}):i.name==a[e]&&0<i.associations.length&&o.association.push(i.associations))}),n.selectedFilters.push(o))}),t()},showTopicBrowser:function(t,e){var i=this;i.data=e,console.log("topics:- ",i.topicData.length),ecEditor.jQuery("#"+e.element).topicTreePicker({data:i.topicData,name:"Topic",picked:e.selectedTopics,onSubmit:function(t){e.callback(t),e.selectedTopics=_.map(t,"name"),i.generateTelemetry({type:"click",subtype:"submit",target:"TopicSelectorSubmit"})},onCancel:function(){i.showTopicBrowser(t,e)},nodeName:"topicSelector_"+e.element,minSearchQueryLength:1})},generateTelemetry:function(t){t&&ecEditor.getService("telemetry").interact({type:t.type,subtype:t.subtype,id:t.target,pageid:org.ekstep.contenteditor.api.getCurrentStage().id||"",target:{id:t.targetid||"",type:"plugin",ver:""},plugin:{id:this.manifest.id,ver:this.manifest.ver,category:"core"},ver:"3.0"})}}))